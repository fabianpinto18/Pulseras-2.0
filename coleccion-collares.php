...
$sql = "SELECT p.* FROM productos p LEFT JOIN categorias c ON p.categoria_id= c.id WHERE p.categoria_id=34 ";
...
<body>
  ...
  <div style="display: inline; margin:90px ">
    <div>
      <h2 style="float: left;margin-left: 80px; ">Nueva Coleccion - Collares</h2>
    </div>
    <div>
